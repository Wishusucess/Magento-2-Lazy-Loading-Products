# Magento-2-Lazy-Loading-Products
Boost your Magento 2 Website speed by Using Wishusucess Lazy Loading Module

# More Description 

Wishusucess Lazy Load Extension has been developed to help to increase the performance of the website in order to speed up websites by with the mechanism of loading products and their images and videos on demand. Therefore, anyone can download and install this extension for optimizing their website's performance.

# How to install Magento 2 Lazy Loading extension

Downlad this module and paste it in the below directory of your website.

app/code/Wishusucess/LazyLoad/
...
Check whether Module is Enabled or Not if not then enable it by using the following command:

php bin/magento module:enable Wishusucess_LazyLoad
